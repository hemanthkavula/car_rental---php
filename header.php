    ...
    <div class="col-5">
        ...
        <div class="justify-content-end overlay-content">
                ...
                ?>
                    ...
                    <a class="nav-link" href="register_agency.php">
                            <i class="fas fa-user visible"></i><b class="bold visible"> Agency Signup</b>
                        </a>
                        <div class="nav-vl"></div>
                        <a class="nav-link" href="login_customer.html">
                            <i class="fas fa-sign-in-alt visible"></i><b class="bold visible"> Login</b>
                        </a>
                        <div class="nav-vl"></div>
                        <a class="nav-link" href="login_agency.html">
                            <i class="fas fa-sign-in-alt visible"></i><b class="bold visible">Agency Login</b>
                        </a>
                <?php
                } else {
                ?>
                    <div class='nav-name align-self-center visible'>
                        ...
                        <a class="nav-link" href="dashboard.php?user_id=<?= $_SESSION['user_id'] ?>">
