...
if(!empty($_POST['email']) && !empty($_POST['full_name']) && !empty($_POST['phone']) && !empty($_POST['gender'])){  
    $email=$_POST['email'];
    $full_name=$_POST['full_name'];
    $phone=$_POST['phone'];
    $gender=$_POST['gender'];
    $query="update users set email='$email',full_name='$full_name',phone='$phone',gender='$gender' where id='$user_id'";
